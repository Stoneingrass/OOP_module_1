...
public class RecordControllerTest {
    ...
    public void testDeleteRecord(){
        ...
        record.setId(5L);
        when(recordRepo.findById(5L)).thenReturn(Optional.of(record));
        recordController.deleteRecord(5L);
        verify(recordRepo, times(5)).deleteById(5L);
    }
    ...
    public void testDeleteRecordInvalidInput() {
        ...
        verify(recordRepo, times(5)).deleteById(invalidId);
    }
}